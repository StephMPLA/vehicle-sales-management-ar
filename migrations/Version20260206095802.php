...
final class Version20260206095802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_request ADD CONSTRAINT FK_5C02341A6BF700BD FOREIGN KEY (status_id) REFERENCES reservation_status (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation_request DROP FOREIGN KEY FK_5C02341A9395C3F3');
        $this->addSql('ALTER TABLE reservation_request DROP FOREIGN KEY FK_5C02341A545317D1');
        $this->addSql('ALTER TABLE reservation_request DROP FOREIGN KEY FK_5C02341A6BF700BD');
